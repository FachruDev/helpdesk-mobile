...
class InternalFilterScreen extends StatefulWidget {
  final String? initialStatus;
  final String? initialStartDate;
  final String? initialEndDate;
  final String? initialSearch;

  const InternalFilterScreen({
    super.key,
    this.initialStatus,
  ...
  @override
  State<InternalFilterScreen> createState() => _InternalFilterScreenState();
}

class _InternalFilterScreenState extends State<InternalFilterScreen> {
