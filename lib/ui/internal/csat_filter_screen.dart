...
class InternalCsatFilterScreen extends StatefulWidget {
  final String? initialTicketStatus;
  final String? initialStartDate;
  final String? initialEndDate;
  final String? initialSearch;

  const InternalCsatFilterScreen({
    super.key,
  ...
  @override
  State<InternalCsatFilterScreen> createState() =>
      _InternalCsatFilterScreenState();
}

class _InternalCsatFilterScreenState extends State<InternalCsatFilterScreen> {
          ...
          children: [
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Search',
                hintText: 'Search by ticket/customer/subject',
